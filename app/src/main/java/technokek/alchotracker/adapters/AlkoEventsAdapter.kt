...
class AlkoEventsAdapter(private val events:MutableList<CalendarModel> = mutableListOf(),
                        private val actionListener: ActionListener) : RecyclerView.Adapter<AlkoEventsViewHolder>() {
